  ...
  return (
    ...
    >
      ...
      {imageBounds
        ...
        : null}
      {markers.length ? (
        <span className="pointer-events-none absolute bottom-2 left-2 rounded-full bg-slate-950/75 px-2 py-1 text-[10px] font-bold text-white shadow-sm backdrop-blur">
  ...
  if (!expanded) {
    return (
      ...
      >
        ...
        <span className="shrink-0 text-[12px] font-semibold text-muted-strong">
          {t("launch.action")}
        </span>
      </button>
    );
      ...
      <div className="p-4">
        ...
        {!countModelPreference.loading && countModelPreference.models.length ? (
          <details className="mb-3 rounded-xl border border-border bg-surface-subtle px-3 py-2.5">
            <summary className="cursor-pointer text-[12px] font-semibold text-muted-strong">
        ...
        {!image ? (
          ...
          <div className="grid gap-3 sm:grid-cols-[minmax(220px,0.9fr)_minmax(0,1.1fr)]">
            ...
            <div className="flex min-w-0 flex-col justify-center">
              {!result ? (
                <>
                  <p className="truncate text-[12px] font-semibold text-muted-strong">
                  ...
                  <div className="mt-3 flex flex-wrap gap-2">
                    ...
                    <label
                      htmlFor={inputId}
                      className="inline-flex h-9 cursor-pointer items-center justify-center rounded-xl border border-border bg-surface px-3 text-[12px] font-semibold text-muted transition hover:bg-surface-subtle"
                    >
        ...
        {result && (result.explanation || result.warnings.length > 0 || !result.isExact) ? (
          <div className="mt-3 rounded-xl border border-border bg-surface px-3.5 py-3 text-[11px] leading-4 text-muted">
        ...
        {result ? (
          <details className="mt-3 rounded-xl border border-border bg-surface-subtle px-3.5 py-2.5 text-[11px] text-muted">
        ...
        {exceedsAvailable ? (
          <p className="mt-3 flex items-start gap-1.5 rounded-xl border border-danger-border bg-danger-soft px-3 py-2.5 text-[11px] leading-4 text-danger">
            <AlertTriangle className="mt-0.5 size-3 shrink-0" aria-hidden="true" />
        ...
        {error ? (
          <div
            className="mt-3 flex items-start justify-between gap-3 rounded-xl border border-danger-border bg-danger-soft px-3 py-2.5 text-[11px] leading-4 text-danger"
            role="alert"
          >
        ...
        {result ? (
          <div className="mt-3 flex flex-wrap gap-2">
            <button
              ...
              disabled={busy}
              className="inline-flex h-8 items-center justify-center gap-1.5 rounded-lg border border-brand-border bg-surface px-3 text-[11px] font-semibold text-brand transition hover:bg-brand-soft disabled:opacity-40"
            >
            ...
            <label
              htmlFor={inputId}
              className="inline-flex h-8 cursor-pointer items-center justify-center rounded-lg border border-border bg-surface px-3 text-[11px] font-semibold text-muted transition hover:bg-surface-subtle"
            >
