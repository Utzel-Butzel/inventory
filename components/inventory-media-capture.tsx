            ...
            {mode === "document" ? (
              <div className="mb-3 space-y-3">
                ...
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <label className="flex min-h-9 items-center gap-2 text-[12px] font-medium text-white/70">
                    <input
                      type="checkbox"
                      checked={autoCapture}
              ...
              {modeOptions.map((option) => {
                ...
                return (
                  <button
                    ...
                    disabled={recording || Boolean(processing)}
                    className={`flex min-h-11 items-center justify-center gap-1.5 rounded-lg px-2 text-[12px] font-bold transition ${
                      mode === option.id
                        ? "bg-white text-slate-950"
