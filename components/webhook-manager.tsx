        ...
        <Card className="border-warning-border bg-warning-soft/40 p-5 sm:p-6">
          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-2 max-w-3xl text-[13px] leading-5 text-muted-strong">
                        ...
                        {webhookDeliveries.map((delivery) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-muted-strong">
                                <span>
                              ...
                              {delivery.error ? (
                                <p className="mt-2 break-words rounded-lg bg-danger-soft px-2.5 py-2 text-[11px] leading-4 text-danger">
                                  {delivery.error}
                                </p>
                              ) : null}
