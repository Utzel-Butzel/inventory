      ...
      <div className={styles.workspace}>
                  ...
                  {resources.map((resource) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span className="shrink-0 rounded-full bg-surface-muted px-2 py-1 text-[12px] font-semibold capitalize text-muted">
                          {resource.type}
                        </span>
                      </button>
                    );
        ...
        <Card className={`${styles.panel} ${styles.previewPanel}`}>
          <div className="border-b border-border p-4 sm:p-5">
            ...
            {setupError ? (
              <p role="alert" className="mt-3 rounded-xl border border-danger-border bg-danger-soft px-3 py-2 text-[13px] leading-5 text-danger">
                {setupError}
              </p>
            ) : activeSetup ? (
              <p className="mt-3 rounded-xl bg-surface-subtle px-3 py-2 text-[13px] leading-5 text-muted">
                {t("setup.summary", {
