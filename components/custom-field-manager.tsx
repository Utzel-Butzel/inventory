...
export function CustomFieldManager() {
  ...
  return (
    <section aria-labelledby="custom-fields-heading">
      ...
      {error ? (
        <div role="alert" className="mb-4 flex items-start justify-between gap-4 rounded-xl border border-danger-border bg-danger-soft px-3.5 py-3 text-[13px] leading-5 text-danger">
          <span>{error}</span>
          <button
            type="button"
      ...
      {notice ? (
        <div role="status" className="mb-4 flex items-start justify-between gap-4 rounded-xl border border-success-border bg-success-soft px-3.5 py-3 text-[13px] leading-5 text-success">
                ...
                {visibleDefinitions.map((definition) => (
                  ...
                  >
                    ...
                    <span className="min-w-0">
                      <span className="block truncate text-[13px] font-semibold text-foreground">{definition.label}</span>
          ...
          <Card className="overflow-hidden">
            ...
            <form onSubmit={saveDefinition} className="space-y-6 p-5 sm:p-6">
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <label className="flex items-center gap-3 self-end rounded-xl border border-border bg-surface-subtle px-3.5 py-3 text-[13px] font-medium text-muted-strong">
                  <input
                    type="checkbox"
              ...
              {draft.fieldType === "number" ? (
                <div className="rounded-xl border border-border bg-surface-subtle p-4">
                  <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.09em] text-muted">
              ...
              {draft.fieldType === "reference" ? (
                <div className="rounded-xl border border-brand-border bg-brand-soft p-4">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <label className="mt-[17px] flex h-10 items-center gap-3 rounded-xl border border-brand-border bg-surface px-3.5 text-[13px] font-medium text-muted-strong">
                      <input
                        type="checkbox"
                  ...
                  <div className="mt-4">
                    ...
                    <div className="mt-2 flex flex-wrap gap-2">
                      <button
                        ...
                        className={cn(
                          "h-8 rounded-lg border px-2.5 text-[11px] font-semibold transition",
              ...
              <div className="rounded-xl border border-border bg-surface-subtle p-4">
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  <button
                    ...
                    className={cn("h-8 rounded-lg border px-2.5 text-[11px] font-semibold transition", !draft.resourceTypes.length ? "border-brand-border bg-brand-soft text-brand" : "border-border bg-surface text-muted hover:bg-surface-hover")}
                  >
                    {t("settings:customFields.allTypes")}
                  </button>
                  {availableResourceTypes.map((option) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn("h-8 rounded-lg border px-2.5 text-[11px] font-semibold transition", active ? "border-brand-border bg-brand-soft text-brand" : "border-border bg-surface text-muted hover:bg-surface-hover")}
                      >
                        {option.label ??
                          t(`settings:customFields.resourceTypes.${option.value}`, {
                            defaultValue: option.value,
