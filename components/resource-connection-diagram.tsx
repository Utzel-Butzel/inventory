          ...
          <div className="border-t border-border">
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-border bg-surface-subtle px-5 py-3 sm:px-6">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <div className="flex min-h-8 max-w-full flex-wrap items-center overflow-hidden rounded-lg border border-border bg-surface text-[12px] font-semibold">
                  <button
                    type="button"
                ...
                {view === "graph" ? (
                  <>
                    {canViewStock ? (
                      <>
                        <label className="flex h-8 cursor-pointer items-center gap-2 rounded-lg border border-border bg-surface px-2.5 text-[12px] font-semibold text-muted-strong">
                          <input
                            type="checkbox"
                            checked={showStock}
                    ...
                    <label className="flex h-8 items-center gap-2 rounded-lg border border-border bg-surface px-2.5 text-[12px] font-semibold text-muted-strong">
...
function ListItem({
  ...
  return (
    <div className="flex items-center gap-2 rounded-xl border border-border bg-surface px-3 py-2.5">
      ...
      {badge ? (
        <Badge tone="brand" className="min-h-5 px-1.5 text-[10px]">
          {badge}
        </Badge>
      ) : null}
      {onRemove ? (
...
function LegendBadge({
  ...
  return (
    <span className="inline-flex items-center gap-1.5 rounded-full border border-border bg-surface px-2.5 py-1 text-[11px] font-semibold text-muted-strong">
      <span
...
function CostStructureIndicator({
  ...
  return (
    ...
    >
      ...
      {totalLabel ? (
        <span className="block truncate text-[10px] font-bold leading-3 text-foreground">
          {totalLabel}
        </span>
      ) : null}
    </span>
      ...
      {directions.map((direction, index) => {
        ...
        return (
          ...
          >
            <span
              className={cn(
                "block truncate text-[9px] font-bold leading-3",
...
function StockIndicator({
  ...
  return (
    <span
      className={cn(
        "absolute -left-2 -top-2 inline-flex max-w-[124px] flex-col items-start gap-0.5 rounded-lg px-2 py-1 text-[10px] font-bold leading-3 tabular-nums shadow-sm ring-1 ring-inset",
