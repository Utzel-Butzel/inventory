    ...
    <header className="border-b border-border bg-surface/95">
      <div className="mx-auto flex h-16 w-full max-w-[1240px] items-center justify-between gap-4 px-4 sm:px-6">
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <span className="hidden rounded-full bg-brand-soft px-2.5 py-1 text-[11px] font-semibold uppercase tracking-wider text-brand sm:inline-flex">
            {viewOnly}
          </span>
            ...
            {resources.map((resource) => (
              ...
              >
                <div className="relative aspect-square overflow-hidden bg-surface-muted">
                  ...
                  />
                  <span className={`absolute left-3 top-3 rounded-full px-2.5 py-1 text-[12px] font-semibold capitalize ring-1 ring-inset ${statusStyles[resource.status] ?? statusStyles.archived}`}>
      ...
      <main className="mx-auto w-full max-w-[1120px] px-4 py-7 sm:px-6 lg:py-10">
        ...
        <header className="mb-6 border-b border-border pb-5">
          <div className="flex flex-wrap items-center gap-3">
            ...
            <span className={`rounded-full px-2.5 py-1 text-[12px] font-semibold capitalize ring-1 ring-inset ${statusStyles[resource.status] ?? statusStyles.archived}`}>
              {t(`statuses.${resource.status}`, {
                defaultValue: humanize(resource.status),
              })}
            </span>
