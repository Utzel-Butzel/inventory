      ...
      {allowImport ? <div className="space-y-4 p-5">
        <div className="flex flex-col gap-3 rounded-xl border border-dashed border-border-strong bg-surface-subtle/70 p-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex shrink-0 gap-2">
            ...
            <label className="inline-flex h-8 cursor-pointer items-center justify-center gap-1.5 rounded-lg border border-border-strong bg-surface px-3 text-[14px] font-medium text-muted-strong shadow-sm transition hover:bg-surface-subtle">
