  ...
  return (
    <div>
      <label className="block">
        <span className="mb-1.5 block px-1 text-[11px] font-semibold uppercase tracking-[0.13em] text-sidebar-muted">
        ...
        <span className="relative flex h-11 items-center rounded-xl border border-border bg-surface px-2.5 shadow-sm transition focus-within:border-focus focus-within:ring-3 focus-within:ring-focus/10">
          ...
          <select
            ...
            className="h-full min-w-0 flex-1 appearance-none bg-transparent pl-2.5 pr-7 text-[13px] font-semibold text-foreground outline-none disabled:cursor-wait"
          >
      ...
      {error ? (
        <p className="mt-1.5 px-1 text-[11px] leading-4 text-danger" role="alert">
          {error}
        </p>
      ) : null}
    </div>
