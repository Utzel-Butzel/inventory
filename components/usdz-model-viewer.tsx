  ...
  return (
    ...
    >
      <div className="relative aspect-square min-h-56 bg-[radial-gradient(circle_at_50%_35%,var(--color-surface),var(--color-surface-muted))]">
        ...
        {status === "ready" ? (
          <span className="pointer-events-none absolute left-3 top-3 inline-flex items-center gap-1.5 rounded-full bg-surface/90 px-2.5 py-1 text-[10px] font-semibold text-muted shadow-sm">
      ...
      <div className="flex flex-wrap items-center gap-2 border-t border-border bg-surface px-3 py-2.5">
        ...
        {supportsQuickLook ? (
          <a
            href={src}
            rel="ar"
            className="inline-flex h-8 items-center gap-1.5 rounded-lg border border-brand-border bg-brand-soft px-2.5 text-[11px] font-semibold text-brand"
          >
        ...
        <a
          ...
          rel="noreferrer"
          download={name}
          className="inline-flex h-8 items-center gap-1.5 rounded-lg border border-border bg-surface-subtle px-2.5 text-[11px] font-semibold text-muted-strong transition hover:border-border-strong"
        >
