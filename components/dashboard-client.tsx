          ...
          <div className="grid gap-5 xl:grid-cols-[minmax(0,1.65fr)_minmax(300px,0.75fr)]">
            <Card className="overflow-hidden">
              <div className="flex items-center justify-between border-b border-border px-5 py-4 sm:px-6">
                ...
                <Link
                  href="/inventory"
                  className="group flex items-center gap-1 text-[13px] font-semibold text-brand hover:text-brand-strong"
                >
                  {t("actions.viewAll")}
                    ...
                    >
                      <div className="flex min-w-0 items-center gap-3">
                        ...
                        <div className="min-w-0">
                          <p className="truncate text-[14px] font-semibold text-foreground transition group-hover:text-brand">
                            {resource.name}
                          </p>
            ...
            <div>
              <Card className="p-5 sm:p-6">
                ...
                {stats.byType.length ? (
                  ...
                  <p className="mt-6 rounded-xl bg-surface-subtle p-4 text-center text-[13px] text-muted">
                    {t("mix.empty")}
                  </p>
                )}
              </Card>
